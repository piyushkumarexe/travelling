/// Central client-side configuration for Roamio.
///
/// SECURITY NOTE: This file must never contain secret API keys. The Roamio
...
class AppConfig {
  ...
  /// Region where the Roamio backend Cloud Functions are deployed.
  ///
  /// Must match the `region` setting in `functions/src/index.js` and the
  /// region used when running `firebase deploy`.
  static const String functionsRegion = 'us-central1';

  /// Base URL of the Roamio backend, derived from the active Firebase
